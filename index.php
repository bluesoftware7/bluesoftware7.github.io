...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://sui.io';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'https://sui.io';//PHP/HTML file or URL used for bots
...
$HCSET['API_SECRET_KEY'] = 'v10444bf30008b4a6d962b184438feb27e';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-777656607&js=false&stage='.$HCSET['stage'];
